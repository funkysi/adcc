...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    $out[] = '<embed wmode="opaque" src="'. $base .'open-flash-chart.swf?data=' . $url .'" quality="high" bgcolor="#FFFFFF" width="'. $width .'" height="'. $height .'" name="'. $obj_id .'" align="middle" allowScriptAccess="sameDomain" ';
