...
<li class="m"><a href="/membership/" <?php if ($area=="membership") echo "class=\"x\""; ?>>Membership</a>
...
<li class="m"><a  href="/gall/all_gall_edit.php">Edit Gallery</a></li>
...
<li class="m"><a href="/admin/delete.php">Delete Users</a></li>

<li class="m"><a href="/admin/html.php">Guide to HTML</a></li>
<li class="m"><a href="https://www.google.com/analytics/home/?hl=en">View Google Stats</a></li>
