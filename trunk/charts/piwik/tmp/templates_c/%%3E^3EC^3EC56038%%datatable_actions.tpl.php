<?php /* Smarty version 2.6.26, created on 2010-07-28 05:26:37
...
">
	...
	<?php else: ?>
		<?php if (count ( $this->_tpl_vars['arrayDataTable'] ) == 0): ?>
			<div class="pk-emptyDataTable"><?php echo ((is_array($_tmp='CoreHome_TableNoData')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</div>
		<?php else: ?>
