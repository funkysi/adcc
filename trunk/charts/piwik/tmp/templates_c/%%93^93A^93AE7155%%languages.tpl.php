...
"><?php echo $this->_tpl_vars['currentLanguageName']; ?>
			...
			<option href='misc/redirectToUrl.php?url=http://piwik.org/translations/'><?php echo ((is_array($_tmp='LanguagesManager_AboutPiwikTranslations')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</option>
