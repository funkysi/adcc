<?php /* Smarty version 2.6.26, created on 2010-07-23 07:57:09
         compiled from /usr/local/psa/home/vhosts/arnoldanddistrictcameraclub.org.uk/httpdocs/charts/piwik/plugins/Feedback/templates/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', '/usr/local/psa/home/vhosts/arnoldanddistrictcameraclub.org.uk/httpdocs/charts/piwik/plugins/Feedback/templates/index.tpl', 29, false),)), $this); ?>
<?php echo '
...
'; ?>
  ...
  <div id="feedback-faq">
    ...
    <p> &bull; <?php echo ((is_array($_tmp='Feedback_ViewAnswersToFAQ')) ? $this->_run_mod_handler('translate', true, $_tmp, "<a target='_blank' href='misc/redirectToUrl.php?url=http://piwik.org/faq/'>", "</a>") : smarty_modifier_translate($_tmp, "<a target='_blank' href='misc/redirectToUrl.php?url=http://piwik.org/faq/'>", "</a>")); ?>
.</p>
    <ul>
    ...
    <p> &bull; <?php echo ((is_array($_tmp='Feedback_VisitTheForums')) ? $this->_run_mod_handler('translate', true, $_tmp, "<a target='_blank' href='misc/redirectToUrl.php?url=http://forum.piwik.org/'>", "</a>") : smarty_modifier_translate($_tmp, "<a target='_blank' href='misc/redirectToUrl.php?url=http://forum.piwik.org/'>", "</a>")); ?>
.</p>
    <p> &bull; <?php echo ((is_array($_tmp='Feedback_LearnWaysToParticipate')) ? $this->_run_mod_handler('translate', true, $_tmp, "<a target='_blank' href='misc/redirectToUrl.php?url=http://piwik.org/contribute/'>", "</a>") : smarty_modifier_translate($_tmp, "<a target='_blank' href='misc/redirectToUrl.php?url=http://piwik.org/contribute/'>", "</a>")); ?>
.</p>
    <br />
...
" alt="[<?php echo ((is_array($_tmp='General_Previous')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
      ...
      <input id="feedback-form-submit" class="feedback-submit" type="submit" value="<?php echo ((is_array($_tmp='Feedback_SendFeedback')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" />
    </form>
  </div>
