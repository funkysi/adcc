<?php /* Smarty version 2.6.26, created on 2010-07-22 22:34:06
...
">
			...
			<div class="tableIconsGroup">
            	<span class="tableAllColumnsSwitch">
                    ...
                    <a class="tableIcon" format="table" var="table"><img title="<?php echo ((is_array($_tmp='General_DisplayNormalTable')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" src="themes/default/images/table.png" /></a>
                    <?php endif; ?>
                    <?php if ($this->_tpl_vars['properties']['show_table_all_columns']): ?>
                    <a class="tableIcon" format="tableAllColumns" var="tableAllColumns"><img title="<?php echo ((is_array($_tmp='General_DisplayMoreData')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" src="themes/default/images/table_more.png" /></a>
                    <?php endif; ?>
                    <?php if ($this->_tpl_vars['properties']['show_goals']): ?>
					<a class="tableIcon" format="tableGoals" var="tableGoals"><img title="<?php echo ((is_array($_tmp='General_DisplayGoals')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
" /></a>
           ...
           <?php endif; ?>			
			...
			<div class="tableIconsGroup">
				<span class="exportToFormatIcons"><a class="tableIcon" var="export"><img width="16" height="16" src="themes/default/images/export.png" title="<?php echo ((is_array($_tmp='General_Export')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" /></a></span>
...
<span class="pk-loadingDataTable"><img src="themes/default/images/loading-blue.gif" /> <?php echo ((is_array($_tmp='General_LoadingData')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span>
</div>
