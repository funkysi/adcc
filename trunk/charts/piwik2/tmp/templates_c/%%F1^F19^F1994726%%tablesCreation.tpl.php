<?php /* Smarty version 2.6.25, created on 2010-01-10 10:46:11
...
<h1><?php echo ((is_array($_tmp='Installation_Tables')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h1>
...
"><?php echo ((is_array($_tmp='Installation_TablesReuse')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 &raquo;</a></p>
	<?php else: ?>
		<p class="nextStep"><a href="<?php echo smarty_function_url(array('action' => $this->_tpl_vars['previousModuleName']), $this);?>
